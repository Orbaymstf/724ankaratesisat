        ...
        >
          {services.map((service, idx) => (
            <motion.div 
              ...
              className="group p-6 md:p-8 rounded-[2rem] bg-slate-900/50 backdrop-blur-lg border border-slate-800/80 hover:border-slate-600 transition-all duration-300 shadow-2xl overflow-hidden relative"
            >
