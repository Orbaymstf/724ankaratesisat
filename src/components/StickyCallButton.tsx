...
export default function StickyCallButton() {
  ...
  const whatsappLink = `https://wa.me/905368440799?text=Merhaba,%20acil%20tesisat%20hizmeti%20için%20ulaşıyorum.`;
      ...
      {isVisible && (
        ...
        >
          ...
          <a 
            ...
            className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl bg-gradient-to-br from-[#25D366] to-[#128C7E] text-white text-lg font-black shadow-[0_10px_30px_-10px_rgba(37,211,102,0.8)] border border-white/10 active:scale-95 transition-transform"
          >
